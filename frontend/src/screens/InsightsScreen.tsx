  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#020617', height: '100%' }}>
      ...
      >
        <View style={{ flex: 1 }}>
        {/* Header */}
        <View className="flex-row justify-between items-center px-5 pt-4 pb-2" style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingTop: 16, paddingBottom: 8 }}>
          <TouchableOpacity>
             <Menu color="#fff" size={24} />
          </TouchableOpacity>
          <View style={{ alignItems: 'center' }}>
            <Text style={{ color: 'white', fontSize: 24, fontWeight: 'bold' }}>Today</Text>
            <Text style={{ color: '#3b82f6', fontWeight: '500' }}>Today, Oct 24</Text>
          </View>
          <TouchableOpacity style={{ backgroundColor: '#1e3a8a', width: 40, height: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center' }}>
             <Text style={{ color: '#93c5fd', fontWeight: 'bold' }}>JD</Text>
          </TouchableOpacity>
        </View>
