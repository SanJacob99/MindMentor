      ...
      >
        ...
        >
          ...
          <View>
            ...
            <View
              className={`flex-row items-center bg-slate-800 rounded-lg border px-4 py-3 mb-4 ${emailFocused ? 'border-blue-500' : 'border-slate-700'}`}
              style={Platform.OS === 'web' && emailFocused ? { boxShadow: '0 0 0 2px rgba(59, 130, 246, 0.5)' } as any : undefined}
            >
            ...
            <View
              className={`flex-row items-center bg-slate-800 rounded-lg border px-4 py-3 mb-6 ${passwordFocused ? 'border-blue-500' : 'border-slate-700'}`}
              style={Platform.OS === 'web' && passwordFocused ? { boxShadow: '0 0 0 2px rgba(59, 130, 246, 0.5)' } as any : undefined}
            >
